            ...
            >
              ...
              <div className="space-y-8 text-[#D1D5DB] text-xl leading-[1.9] max-w-xl">
                ...
                <p>
                  ...
                  — enabling schools to evolve beyond compliance towards
...
`}</style>
                            ...
                            {[...blocks].reverse().map((block, ri) => {
                              ...
                              const faceOpacity = [0.65, 0.52, 0.4, 0.3, 0.22][
                                i
                              ];
                              const topOpacity = [0.5, 0.42, 0.36, 0.3, 0.24][
                                i
                              ];
                              const dimOpacity = [0.45, 0.38, 0.32, 0.26, 0.2][
                                i
                              ];
...
"
              ...
              <div className="relative min-h-[300px] w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                ...
                <div className="absolute inset-0 rounded-[28px] border border-[#F4B942]/40 bg-[#F4B942]/15 backdrop-blur-xl overflow-hidden [transform:rotateY(180deg)] [backface-visibility:hidden]">
                  ...
                  >
                    ...
                    >
                      No template-based approach. Every recommendation is
                      tailored to your school's goals, scale, and long-term
                      aspirations.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative min-h-[300px] w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                ...
                <div className="absolute inset-0 rounded-[28px] border border-[#F4B942]/40 bg-[#F4B942]/15 backdrop-blur-xl overflow-hidden [transform:rotateY(180deg)] [backface-visibility:hidden]">
                  ...
                  >
                    ...
                    >
                      We grow with your institution, providing continuous
                      guidance rather than one-time consultancy.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section
          id="impact"
          className="relative z-10 pb-32 pt-24 px-8 md:px-20"
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          >
            ...
            >
              Track Record &{" "}
              <span className="text-[#F4B942]">Institutional</span>
              <br />
          ...
          <div className="grid lg:grid-cols-2 gap-10 mb-10 items-stretch">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="india-map-card rounded-[32px] border border-white/10 bg-white/[0.04] backdrop-blur-xl flex flex-col group justify-between"
              style={{
          ...
          <motion.div
            ...
            transition={{ duration: 0.9 }}
            viewport={{ once: true }}
            className="affiliation-outer-card rounded-[32px] border border-[#F4B942]/18 mb-8 overflow-hidden mt-10"
            style={{
              background:
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Holy Cross School, Ambikapur engaged Wonder Illuminate Service
                of Education Pvt. Ltd. for campus shifting and section increase
                approval. Through structured documentation, compliance
                management, and inspection preparedness, the entire process was
                completed within just 15 days.
              </motion.p>
            ...
            >
              <div>
                ...
                <p
                  ...
                  style={{ marginTop: "1.5rem" }}
                >
                  Whether you're planning a new school, seeking CBSE
                  affiliation, or looking to strengthen your institution's
                      ...
                      {href ? (
                        label === "Phone" ? (
                          <div className="flex items-center gap-2 text-base font-medium contact-phone-row">
                            ...
                            <span className="text-[#F4B942] font-bold contact-phone-sep">
                              |
                            </span>
                            <a
