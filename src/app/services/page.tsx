    ...
    <main className="relative bg-[#14071A] text-white overflow-hidden">
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              From school establishment and affiliation to academics, training,
              examinations, and institutional development — WISE provides
              end-to-end solutions tailored to each school's unique vision.
            </motion.p>
                            ...
                            >
                              {phase.items.map((item) => (
                                ...
                                >
                                  <BadgeCheck
                                    size={15}
                                    style={{ color: "#F4B942", flexShrink: 0 }}
                                  />
                                  {item}
                                </li>
                              ))}
          ...
          <div className="grid lg:grid-cols-[1.35fr_1fr] gap-0">
            ...
            >
              <p className="text-white/65 text-lg leading-relaxed">
                ...
                transforming ideas into structured, compliant, and future-ready
      ...
      <section id="services-cta" className="relative z-10 px-8 md:px-20 py-24">
        ...
        >
          ...
          >
            Whether you are planning a new institution, seeking affiliation, or
            strengthening existing systems, WISE is here to support your
            journey.
          </p>
