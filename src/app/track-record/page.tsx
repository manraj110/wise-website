...
export default function TrackRecordPage() {
  return (
    <main className="relative bg-[#14071A] text-white overflow-hidden">
        ...
        <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-10 items-center w-full">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Every project represents our commitment to quality, precision, and
        ...
        <div className="relative grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-[#D1D5DB] text-xl leading-[1.9] max-w-xl">
              ...
              <p>
                From documentation and planning to execution and follow-up, our
                focus remains on delivering complete, accurate, and satisfactory
                outcomes for every institution we serve.
              </p>
            </div>
            ...
            <svg width="340" height="400" viewBox="0 0 320 380">
              <defs>
                <linearGradient id="shieldBody" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <stop offset="100%" stopColor="#1B0826" stopOpacity="0.65" />
                </linearGradient>
      ...
      >
        ...
        >
          ...
          >
            ...
            educational requirements extending beyond standard affiliation work.
          </p>
        </motion.div>
      ...
      <section id="complex-cases" className="relative z-10 px-8 md:px-20 pb-16">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          ...
          <p className="text-white/55 text-xl max-w-2xl leading-relaxed">
            ...
            thoughtful planning and customized solutions. WISE approaches every
            challenge with flexibility, experience, and a solution-oriented
            mindset.
          </p>
        </motion.div>
      ...
      <section id="partnerships" className="relative z-10 px-8 md:px-20 pb-16">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <section id="institutions" className="relative z-10 px-8 md:px-20 pb-16">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <section id="how-we-grow" className="relative z-10 px-8 md:px-20 pb-16">
        ...
        >
          ...
          <p className="text-white/55 text-xl max-w-2xl leading-relaxed">
            For years, WISE has grown primarily through recommendations and the
            confidence placed in us by educational institutions. Our greatest
            source of growth has always been the trust and satisfaction of the
            schools we serve.
          </p>
        </motion.div>
      ...
      <section id="testimonials" className="relative z-10 px-8 md:px-20 pb-16">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <section id="looking-ahead" className="relative z-10 px-8 md:px-20 pb-16">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
