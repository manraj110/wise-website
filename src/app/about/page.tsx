            ...
            <div className="grid lg:grid-cols-2 gap-20 items-start">
              ...
              >
                <p>
                  ...
                  by Ms. Sanskriti Singh and Dr. Suresh Singh with a shared
                  vision of strengthening educational institutions through
                  structured systems and meaningful learning.
                </p>
                <p>
                ...
                <p>
                  Today, WISE serves schools across multiple states and
                  continues to work towards building institutions that
                  prioritize academic excellence, student development, and
                  sustainable growth.
                </p>
              </motion.div>
...
============================================================ */}
        <section className="relative z-10 px-8 md:px-20 py-32">
          ...
          <div style={{ marginLeft: "2rem", marginRight: "2rem" }}>
            ...
            >
              Education Beyond{" "}
              <span className="text-[#F4B942]">Compliance</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              regulations — they should nurture curiosity, critical thinking,
              and lifelong learning. Our approach combines academic depth,
              structured systems, and long-term partnerships.
            </motion.p>
          ...
          <div style={{ marginLeft: "2rem", marginRight: "2rem" }}>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-stretch">
             ...
             transition-colors duration-400"
                  >
                    <div className="founder-card-pad flex flex-col-reverse lg:flex-row gap-8 lg:gap-10 items-center p-8 lg:p-[3.5rem]">
                      {/* LEFT (desktop) / BOTTOM (mobile) — content */}
                      <div className="flex flex-col gap-5 flex-[1.3] w-full items-center text-center lg:items-stretch lg:text-left">
                        <div>
                      ...
                      <div className="w-[180px] h-[180px] lg:w-[260px] lg:h-[260px] flex-shrink-0 rounded-full bg-[#F4B942]/15 border-2 border-[#F4B942]/40 flex items-center justify-center overflow-hidden group-hover:border-[#F4B942]/70 group-hover:shadow-[0_0_30px_rgba(244,185,66,0.25)] transition-all duration-300">
                        {img ? (
                          <img
                            src={img}
                            alt={name}
        ...
        <section className="relative z-10 px-8 md:px-20 py-32 overflow-hidden">
          ...
          <div style={{ marginLeft: "2rem", marginRight: "2rem" }}>
            ...
            <motion.p
              ...
              style={{ marginBottom: "4rem" }}
            >
              WISE currently supports schools across multiple states and
              continues to expand its presence through long-term institutional
              partnerships.
            </motion.p>
